...
Attention, si vous avez déjà Wine sur votre machine qui possède une distribution basée sur Ubuntu, mais que c'est une version inférieure à la 11, le script la mettra à jour automatiquement.
